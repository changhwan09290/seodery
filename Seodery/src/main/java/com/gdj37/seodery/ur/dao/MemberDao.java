...
import com.gdj37.seodery.ur.action.MemberBean;
import com.gdj37.seodery.ur.dto.MemberDTO;

import com.gdj37.seodery.ur.action.DBConnection;
...
public class MemberDao {
	 private static MemberDao instance;
	    ...
	    public void insertMember(MemberDTO member) throws SQLException
	    {
	        ...
	        try {
	            // 커넥션을 가져온다.
	            conn = com.gdj37.seodery.ur.action.DBConnection.getConnection();
	    ...
	    private void stringToDate(MemberDTO member) {
	    ...
	    public MemberBean getUserInfo(String id) 
	    {
	        ...
	        try {
	            ...
	            query.append("SELECT * FROM UR_MEMBER WHERE ID=?");
