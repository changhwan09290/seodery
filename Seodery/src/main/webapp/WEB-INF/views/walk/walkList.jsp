...
function makeTable(jsonData) {
    ...
    for (var idx in result) {
         // button ='<td><input type="button" value="상세보기" onClick="location.href=moveDtl?pageNum='+idx+'" class="dtl_btn" id="dtlBtn'+idx+'" /></td>';
        //var button ='<td><input type="button" value="상세보기" class="dtl_btn" id="DtlBtn"></td>';
         ...
         //html += "<td>" + '<input type="button" value="상세보기" onclick="location.href=moveDtl?pageNum='+idx+'" class="dtl_btn" id="dtlBtn'+idx+'" />' + "</td>";
         //html += "<td>" + '<input type="button" value="상세보기" onclick="moveDtlFunc(\'' + result[idx].COURSE_NAME,result[idx].CPI_NAME + '\')" class="dtl_btn" id="dtlBtn'+ result[idx].COURSE_NAME,result[idx].CPI_NAME +'" />' + "</td>";
         //html += "<td>" + '<input type="button" value="상세보기" onclick="moveDtlFunc(\'' + result[idx].COURSE_NAME + '\',\''+ result[idx].CPI_NAME + '\')" class="dtl_btn" id="dtlBtn" />' + "</td>";
         //html += "<td>" + '<input type="button" value="상세보기" onclick="moveDtlFunc(\'' + result[idx].COURSE_NAME + '\',\''+ result[idx].CPI_NAME + '\')" class="dtl_btn" id="dtlBtn" />' + "</td>";
         html += "<td>" + '<input type="button" value="상세보기" onclick="moveDtlFunc(\'' + result[idx].COURSE_NAME + '\',\''+ result[idx].CPI_NAME + '\',\''+ idxtotal + '\')" class="dtl_btn" id="dtlBtn" />' + "</td>";
         html += "</tr>";
    ...
    for (var idx in result){
    	html += "<tr>";
    	//html += "<td>"+'<input type="hidden" class="cos">' + result[idx].AREA_GU + "</td>";
    	html += "<td>"+'<input type="hidden" class="cos">' + JSON.stringify(result[idx].AREA_GU) + "</td>";
    	html += "<td>"+'<input type="hidden" class="cos">' + JSON.stringify(result[idx].LEAD_TIME) + "</td>";
    	//console.log(JSON.stringify(result[idx].AREA_GU))
    	var area = JSON.stringify(result[idx].AREA_GU);
    	var time = JSON.stringify(result[idx].LEAD_TIME)
...
function moveDtlFunc(cosn,cpin) {
   //alert(cosn);
   //alert(cpin);
   location.href ="moveDtl?cosn=" + cosn + "&cpin=" + cpin; //쿼리스트링
}
