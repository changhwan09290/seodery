<%@page import="com.gdj37.seodery.ur.dao.MemberDao"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import="com.gdj37.seodery.dust.dao.*" %>    
<%@ page import="com.gdj37.seodery.ur.action.*" %>  
...
<%
    ...
    %>
        ...
        <input type="button" value="확인" onclick="javascript:window.location='mainpage.jsp'">
