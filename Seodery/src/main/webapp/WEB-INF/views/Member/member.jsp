...
<main>
 ...
 <form method="post" action="joinPro" 
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" name="passwordcheck" maxlength="50"><br>
                    </td>
                </tr>
            ...
            <div class="wp2">
            	<input type="submit" value="가입" onclick="linkGo('idCheckForm')"/>  <input type="button" value="취소">
            </div>
